...
// IssueContractAddress is a free data retrieval call binding the contract method 0xae18f5ad.
//
// Solidity: function issueContractAddress() view returns(address)
func (_Erc20 *Erc20Caller) IssueContractAddress(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Erc20.contract.Call(opts, &out, "issueContractAddress")
...
//
// Solidity: function issueContractAddress() view returns(address)
func (_Erc20 *Erc20Session) IssueContractAddress() (common.Address, error) {
	return _Erc20.Contract.IssueContractAddress(&_Erc20.CallOpts)
}

// IssueContractAddress is a free data retrieval call binding the contract method 0xae18f5ad.
//
// Solidity: function issueContractAddress() view returns(address)
func (_Erc20 *Erc20CallerSession) IssueContractAddress() (common.Address, error) {
	return _Erc20.Contract.IssueContractAddress(&_Erc20.CallOpts)
}
